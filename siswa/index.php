...
<head>
  ...
  <title>Aplikasi SPP Digital</title>
<!-- DataTables -->
...
<div class="wrapper">
			...
			<?php 
			 ...
			 ?>
			  ...
			  <div class="card-header">
                <h5 class="card-title m-0"><b>HISTORY PEMBAYARAN</b></h5>
              </div>
              <div class="card-body">
			  <?php
		if(isset($_GET['pesan'])){
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
     <a href="https://quran.kemenag.go.id/">Sudahkah Kamu Mengaji Hari Ini?
    </a></div>
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y');?> <a href="http://localhost/spppamuji/siswa/">Aplikasi SPP - Siswa</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
