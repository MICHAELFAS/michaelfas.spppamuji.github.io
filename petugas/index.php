...
<div class="preloader">
  <div class="loading">
		<img src="../themes/dist/img/load.gif" width="384"> 
  </div>
</div>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://localhost/spppamuji/petugas/?hal=beranda">Aplikasi SPP</a>.</strong>  
  </footer>
